...
_2026-06-18 20:06:32 UTC · commit `4062eb1`_
...
parquet (zstd)         22.61       22.61    4.189      5.93                (1.00x vs pq)
rust lance              9.99        9.99    3.472      5.57                (0.83x vs pq)
nanolance              24.40       31.76    3.643     10.98         8.59   (0.87x vs pq)

========== wide_int  (200000 rows, 4 cols) ==========
engine           write(core) write(proc)    B/row   read ms  read(lance)
parquet (zstd)         23.99       23.99    5.212      3.53                (1.00x vs pq)
rust lance              2.58        2.58    8.485      3.61                (1.63x vs pq)
nanolance              10.50       13.78    9.013     12.10        11.35   (1.73x vs pq)

========== high_card  (200000 rows, 2 cols) ==========
engine           write(core) write(proc)    B/row   read ms  read(lance)
parquet (zstd)         29.87       29.87   15.513      7.86                (1.00x vs pq)
rust lance             16.89       16.89   18.910      5.38                (1.22x vs pq)
nanolance             150.23      155.29   18.206     15.24        10.95   (1.17x vs pq)
...
D1 cache: 
LL cache: 
Timerange: Basic block 0 - 20189231
Trigger: Program termination
Profiled target:  build/nlbench /tmp/nlb/pcap_ref_nl.lance 1 (PID 4983, part 1)
Events recorded:  Ir
Events shown:     Ir
Event sort order: Ir
Thresholds:       98
...
Ir                  
--------------------------------------------------------------------------------
39,425,865 (100.0%)  PROGRAM TOTALS
