...
_2026-07-10 03:52:49 UTC · commit `2f903b5`_
...
parquet (zstd)         22.45       22.45    4.189      6.09                (1.00x vs pq)
rust lance             10.55       10.55    3.472      5.51                (0.83x vs pq)
nanolance               8.94       16.55    3.643      9.25         8.69   (0.87x vs pq)

========== wide_int  (200000 rows, 4 cols) ==========
engine           write(core) write(proc)    B/row   read ms  read(lance)
parquet (zstd)         23.31       23.31    5.212      3.62                (1.00x vs pq)
rust lance              2.58        2.58    8.485      3.57                (1.63x vs pq)
nanolance               9.11       12.40    9.013      9.52        11.83   (1.73x vs pq)

========== high_card  (200000 rows, 2 cols) ==========
engine           write(core) write(proc)    B/row   read ms  read(lance)
parquet (zstd)         29.29       29.29   15.513      7.86                (1.00x vs pq)
rust lance             16.92       16.92   18.929      5.56                (1.22x vs pq)
nanolance              33.52       38.63   18.206     13.72        11.35   (1.17x vs pq)

========== float_smooth  (200000 rows, 2 cols) ==========
engine           write(core) write(proc)    B/row   read ms  read(lance)
parquet (zstd)         24.24       24.24   14.600      2.99                (1.00x vs pq)
rust lance              2.66        2.66   11.991      3.22                (0.82x vs pq)
nanolance               8.07       11.00    8.399      3.95         6.77   (0.58x vs pq)

========== bool_flags  (200000 rows, 1 cols) ==========
engine           write(core) write(proc)    B/row   read ms  read(lance)
parquet (zstd)          1.90        1.90    0.128      1.42                (1.00x vs pq)
rust lance              1.27        1.27    0.129      2.14                (1.01x vs pq)
nanolance               1.50        2.87    0.127      0.84         2.67   (0.99x vs pq)
...
D1 cache: 
LL cache: 
Timerange: Basic block 0 - 17530893
...
Ir                  
--------------------------------------------------------------------------------
31,294,956 (100.0%)  PROGRAM TOTALS
